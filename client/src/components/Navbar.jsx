...
function Navbar() {
  ...
  return (
    <div className='hede '>
      <div className={`  ${isTrasparent &&  'fixed z-50  '} w-[100%] flex flex-row  h-[93px] items-center  justify-between px-10 ${isTrasparent && 'shadow-3xl'} ${isTrasparent? 'bg-white' :'bg-transparent'} `}>
