  ...
  const Cardd=(props)=>{
    ...
    return(
        ...
        <div className=" w-full">
          ...
          <nav className=" w-full  pt-8 flex flex-row justify-center gap-3    max-ml:grid max-ml:grid-cols-4 max-sm:grid-cols-2 max-md:grid-cols-3 place-items-center text-xl max-sm:text-lg ">
